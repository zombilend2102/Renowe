...
def create_html_file(data):
    ...
    html_content = HTML_TEMPLATE.replace("{SERIES_CONTENT}", series_content)
    html_content = html_content.replace("{DIZILER_JSON}", json.dumps(js_diziler, ensure_ascii=False))
