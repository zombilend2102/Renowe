    ...
    <script>
        document.querySelectorAll('.channel-item').forEach(item => {{
            item.addEventListener('click', function() {{
                ...
                playerDiv.innerHTML = `<iframe src="${{channelUrl}}" allow="autoplay; fullscreen"></iframe>`;
            }});
        }});
...
for name, cid, logo in channels:
    ...
    proxy_url = f"https://cdn.theoplayer.com/demos/iframe/theoplayer.html?autoplay=false&muted=false&preload=none&src={PROXY + full_url}"
