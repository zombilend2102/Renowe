...
def main():
    print("Diziler ve Bölümler taranıyor... (MP4 & M3U8 Desteği Aktif)")
                ...
                if video_div and video_div.get("data-hope-video"):
                    try:
                        ...
                        if video_url:
                            ...
                            print(f"      - {display_name} Video Kaynağı (M3U8/MP4) Bulunamadı.")
...
<body>
    ...
    <script>
        ...
        function showBolumler(diziID) {{
            ...
            if (diziler[diziID]) {{
                // Diziler Python'da sıralandı, burada listeliyoruz
